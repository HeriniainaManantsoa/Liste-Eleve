...
private slots:
    ...
    void on_boutonRetourPage_4_clicked();

    void on_boutonRetourPage_5_clicked();

    void on_boutonRetourPage_6_clicked();

    void on_boutonRetourPage_7_clicked();

    void on_boutonRetourPage_8_clicked();
