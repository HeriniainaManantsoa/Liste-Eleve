...
public:
    ...
    QLineEdit *menttionValeurPage_7;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        boutonPage_4 = new QPushButton(page_4);
        boutonPage_4->setObjectName("boutonPage_4");
        boutonPage_4->setGeometry(QRect(320, 360, 111, 41));
        ...
        pushButton->setGeometry(QRect(30, 30, 61, 29));
        ...
        boutonPage_6 = new QPushButton(page_6);
        boutonPage_6->setObjectName("boutonPage_6");
        boutonPage_6->setGeometry(QRect(340, 320, 111, 41));
        pushButton_3 = new QPushButton(page_6);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(30, 40, 61, 29));
        ...
        menttionValeurPage_7 = new QLineEdit(formLayoutWidget);
        menttionValeurPage_7->setObjectName("menttionValeurPage_7");

        formLayoutPage_7->setWidget(4, QFormLayout::ItemRole::FieldRole, menttionValeurPage_7);

        boutonPage_7 = new QPushButton(page_7);
        boutonPage_7->setObjectName("boutonPage_7");
        boutonPage_7->setGeometry(QRect(340, 440, 111, 41));
        pushButton_4 = new QPushButton(page_7);
        pushButton_4->setObjectName("pushButton_4");
        pushButton_4->setGeometry(QRect(20, 30, 61, 29));
        ...
        boutonPage_8 = new QPushButton(page_8);
        boutonPage_8->setObjectName("boutonPage_8");
        boutonPage_8->setGeometry(QRect(420, 450, 111, 41));
        pushButton_5 = new QPushButton(page_8);
        pushButton_5->setObjectName("pushButton_5");
        pushButton_5->setGeometry(QRect(20, 30, 61, 29));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_3->setText(QCoreApplication::translate("MainWindow", "retour", nullptr));
        ...
        pushButton_4->setText(QCoreApplication::translate("MainWindow", "retour", nullptr));
        ...
        pushButton_5->setText(QCoreApplication::translate("MainWindow", "retour", nullptr));
    } // retranslateUi
